...
if not os.path.exists(os.path.join(resultsRoot,userFolder, filePath)):
	...
	print('File already exists. Its content is:')
	with open(os.path.join(resultsRoot,userFolder, filePath)) as f:
		print(f.read())
