...
In the results download you will find two folders: Logos and Motifs; and two files: tab_enriched_motifs.txt and tab_sequences.txt.
...
-The motifs folder contains a text file for each motif found enriched in the user's input by BRIO. Inside these files every row represent an occurrence of the motif in one of the input sequence/s.
...
tab_enriched_motifs.txt:
------------------------

This file contains the information of the Enriched Motifs table of the results, where each tab separated column represent:
...
This file contains the information of the Sequences table of the results, where each tab separated column represent:
